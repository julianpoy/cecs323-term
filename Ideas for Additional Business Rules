Ideas for Additional Business Rules
...
5) Dave’s Auto Repair Shop has temporary cars for customers whose cars need extensive work.
***Implementation: This rule would require a table for cars owned by Dave’s Auto Repair Shop. The table might include such attributes as make, model, year, etc.***
